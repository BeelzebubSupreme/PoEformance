...
POEFORMANCE_VERSION := "0.45.13.60"
...
g_cfgOpenSections := "status,autoflask,radar,entities,actions,al-conditions,al-timing,al-output"  ; comma-separated open detail sections
